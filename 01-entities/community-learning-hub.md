...
The Community & Learning Hub is Sebenza Hub's engagement engine for [[01-entities/individual-user|Individual]] users. It combines a social community forum, structured learning paths, skill verification, mentorship, and gamification to keep job seekers developing their careers between applications.
...
- [[01-entities/individual-user]] — Primary users of community and learning
- [[03-workflows/individual-journey]] — Learning (Step 9) and Community (Step 11) in the full journey
- [[02-concepts/ai-features]] — AI in learning recommendations and interview prep
- [[06-comparisons/user-type-comparison]] — Learning is Individual-only
