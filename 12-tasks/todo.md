...
- [x] **Add job aggregation entity page** — Created [[01-entities/job-aggregation]] covering Adzuna + CareerJet
- [x] **Add entity page for WhatsApp Bot** — Created [[01-entities/whatsapp-bot]] deep-dive (20 admin tabs, flow builder, DNA analyzer)
...
- [x] **Create SEO strategy concept page** — Created [[02-concepts/seo-strategy]]

## Remaining Wiki Work

- [ ] **Fully resolve open questions** — All 4 questions are at medium confidence; need codebase access to reach high confidence:
  - [[08-questions/recruiter-business-relationship]] — Need to read vendor management page code
  - [[08-questions/trust-tier-calculation]] — Need to find trust score calculation in server code
  - [[08-questions/subscription-plans]] — Need to read plans seed data and pricing page component
  - [[08-questions/ai-provider-selection]] — Need to read `ai_feature_configs` table and routing logic
