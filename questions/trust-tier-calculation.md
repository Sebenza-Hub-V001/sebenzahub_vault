...
Based on the recruitment features documentation ([[sources/recruitment-features-2026-04-07]]), the reputation system is informed by several measurable signals:
...
The AI enhancement audit ([[sources/ai-enhancement-opportunities-2026-04-07]]) mentions `scoreCandidateEngagement()` as an existing AI function — this may feed into trust scoring.
