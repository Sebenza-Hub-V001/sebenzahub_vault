...
- **Autopilot / Individual agent** ([[16-manuals/individual/20-autopilot]]) — still has open operational questions; Managed Agents could be a concrete target architecture for this feature rather than building bespoke orchestration.
...
| 2 | **Adopt Managed Agents as the target runtime for Autopilot.** Autopilot ([[16-manuals/individual/20-autopilot]]) is blocked on operational details — specifically around sandboxing, state, and tool permissions. Managed Agents solves those primitives. Make Managed Agents the assumed architecture in the Autopilot design doc and close out the open question. | [[16-manuals/individual/20-autopilot]], [[08-questions/ai-provider-selection]] | high | high |
...
- Related wiki pages: [[02-concepts/ai-features]], [[01-entities/whatsapp-bot]], [[01-entities/screening-system]], [[16-manuals/individual/20-autopilot]], [[08-questions/ai-provider-selection]], [[02-concepts/billing-system]], [[02-concepts/rbac]]
