...
Treat it like a real interview, even though nobody is watching:
...
## Step 4 — Read the feedback properly

After each answer (or at the end), you'll get structured feedback. It usually covers three dimensions:
...
| **Structure** | Was your answer well-organised? Did you use a recognisable framework like STAR (Situation, Task, Action, Result)? |
| **Delivery** | Pace, filler words, tone, body language (for video). Confidence without arrogance. |

Read the feedback the same way you read CV Review feedback in Chapter 6: assume the criticism is right unless you have a specific reason to disagree. The most common failure modes:
...
## Sessions for a specific upcoming interview

Once you have a real interview booked, switch to focused prep:

1. Open Company Research (Chapter 14) and read about the company.
2. Open Interview Simulator and configure the session for that company and role.
3. The AI can usually generate likely questions based on the JD.
4. Run through them. Focus on the two or three answers you struggled most with.
5. Re-run those specific questions a second time after the feedback.
6. Stop. Sleep. Don't over-prep — at some point more practice makes you stiffer, not better.
...
- [ ] Completed at least one mock interview session
- [ ] Tried at least one video answer (even though it was awkward)
- [ ] Read the feedback and noted at least one specific thing to improve
- [ ] You know the difference between behavioural, technical, and case-study modes
- [ ] You have a plan to do at least three sessions before any real interview
