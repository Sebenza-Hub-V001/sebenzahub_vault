...
|-----------|------|--------------|-----------------|----------|
| **[[entities/individual-user]]** | Job Seeker | Find jobs, build skills, manage career | 85 | 42 (56+ documented) |
| **[[entities/recruiter-user]]** | Talent Agency | Source candidates, manage clients, earn placement fees | 86 | 86 (95+ documented) |
| **[[entities/business-user]]** | Employer / Corporate HR | Post jobs, hire directly, manage workforce | 15 | 29 |
| **[[entities/admin-user]]** | Platform Operator | Configure platform, monitor health, ensure compliance | 104 | — |
...
The key relationship triangle: Recruiters act as **intermediaries** between Individuals and Businesses. A Business can hire directly (bypassing recruiters) or through a Recruiter (who earns a fee). See [[concepts/application-lifecycle]] for the full flow, and [[questions/recruiter-business-relationship]] for open questions about the vendor relationship.
...
Not just a job board — a complete career development ecosystem. Individuals get AI-powered job matching, CV review, cover letter generation, interview simulation, salary negotiation coaching, skill gap analysis, learning paths, SETA learnerships, portfolio builder, mentorship, and community. See [[sources/individual-features-2026-04-07]] for full documentation of 56+ features.

### 2. Recruitment ATS + CRM for Agencies
A full ATS + CRM + business intelligence suite comparable to standalone products like Bullhorn or Greenhouse. Recruiters manage the complete lifecycle: source → screen → evaluate → interview → offer → place. The Revenue Engine (client pipeline, submissions, placements, KPI tracking) makes this a business tool, not just a hiring tool. See [[sources/recruitment-features-2026-04-07]] for full documentation of 95+ features.
...
The AI backbone is **excellent** — 42 functions across OpenAI, Anthropic Claude, and Google Gemini, with admin-configurable per-feature model selection. But [[sources/ai-enhancement-opportunities-2026-04-07]] reveals that **83% of pages don't use AI at all**.
...
Infrastructure gaps: no background AI job queue, no real-time streaming, dormant job embeddings table, no proactive AI notifications. See [[concepts/ai-features]] for details.

## WhatsApp: A Platform Within the Platform

The [[entities/whatsapp-bot]] is not a simple chatbot — it's a complete recruitment operating system via WhatsApp (SA's dominant messaging platform). It supports 6 SA languages, POPIA consent, CV parsing, job search, applications, screening interviews, career coaching, and frustration-driven human escalation.

The admin WhatsApp dashboard alone has **20 tabs** — including a visual flow builder (9 node types), DNA Analyzer (conversation pattern classification), War Room (escalation prediction), and Growth Engine (viral/referral tracking). See [[sources/whatsapp-bot-training-manual-2026-04-07]].
...
| Application Lifecycle | [[concepts/application-lifecycle]] |
| AI Features | [[concepts/ai-features]] |
...
- [[questions/recruiter-business-relationship]] — How vendor relationships are established (medium confidence)
- [[questions/trust-tier-calculation]] — How recruiter trust tiers are calculated (medium confidence)
- [[questions/subscription-plans]] — What are the 18 plans and their pricing (medium confidence)
- [[questions/ai-provider-selection]] — How AI providers are routed per feature (medium confidence)
...
- [[sources/features-inventory-2026-04-07]] — Platform features inventory
- [[sources/individual-features-2026-04-07]] — Individual features guide
- [[sources/recruitment-features-2026-04-07]] — Recruitment features guide
- [[sources/ai-enhancement-opportunities-2026-04-07]] — AI enhancement audit
- [[sources/seo-plan-2026-04-07]] — SEO strategy document
- [[sources/whatsapp-bot-training-manual-2026-04-07]] — WhatsApp bot manual
- [[tasks/todo.md]] — Current task backlog
- [[tasks/lessons.md]] — Patterns and corrections
