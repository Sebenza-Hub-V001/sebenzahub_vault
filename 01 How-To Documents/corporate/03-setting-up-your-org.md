...
created: 2026-04-20
updated: 2026-04-26
tags: [how-to, corporate, team, rbac, sso, branding, collaboration, billing]
status: active
user-types: [business]
---
...
This chapter covers six features in the order you should set them up. The Team page lives in the **Organization** sidebar group at the top of the dashboard (next to Overview); Settings, Billing, and SSO Config live in the **Account** sidebar group at the bottom — they're admin pages you set up once and rarely revisit, not part of the recurring hiring journey. One housekeeping note before you start: **Billing** ([https://www.sebenzahub.co.za/dashboard/business/billing](https://www.sebenzahub.co.za/dashboard/business/billing)) is gated to Admin / owner. If your finance contact is different from your TA owner, make sure they have an Admin seat now — they'll need it to convert the trial to a paid plan in [[01 How-To Documents/corporate/04-trial-and-billing-lifecycle|Chapter 4]].
...
5. Repeat for every recruiter, hiring manager, and HRBP who needs access. Don't invite occasional interviewers as full team members — use the interviewer scorecard flow instead (covered in [[01 How-To Documents/corporate/07-screening-and-evaluating|Chapter 7]] and [[01 How-To Documents/corporate/08-interviewing|Chapter 8]]) to keep your seat count clean.
