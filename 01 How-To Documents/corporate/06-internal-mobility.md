---
title: "Chapter 6 — Internal mobility"
type: concept
created: 2026-04-20
updated: 2026-04-20
tags: [how-to, corporate, internal-mobility, succession, performance, retention]
status: active
user-types: [business]
---

# Chapter 6 — Internal mobility

Internal hires are the cheapest source of talent and the strongest retention lever you have. They cost a fraction of an external hire, ramp faster, and tell every other employee that growth here is real. Most SA corporates have an internal mobility *policy* that nobody runs because there's no system supporting it. This chapter sets up the system.

Three features work together: an **Internal Job Board** for surfacing roles to existing employees, **Succession Planning** for identifying the people you want to develop into specific future roles, and **Performance Management** for closing the loop between hiring decisions and how people actually perform.

## Why this order

You start with the Internal Job Board because it's the operational front door — the thing employees interact with daily. Succession Planning sits one layer up: it's how you decide who you'd want to see in a role *before* it's posted. Performance Management sits underneath both: it's the data that makes succession defensible and internal hiring decisions auditable.
...
1. Go to **Settings → Internal Job Board** and enable it for your organisation.
...
1. Go to **Succession Planning** and identify your **critical roles** — the roles where a sudden exit creates material business risk. Typically: every C-level, every direct report to the CEO, and any specialist role with a single point of failure (e.g., the only person who knows the legacy billing system).
...
### Performance Management — _Tier: Premium_

**What this feature is.** Performance Management is the employee performance tracking and review tool inside Sebenza Hub — review cycles, ratings, manager and peer feedback, and competency scorecards — integrated with hiring history. The interview scorecards used to *hire* someone become traceable to how they actually *perform*, closing the loop on hiring quality.
...
1. Go to **Performance Management** and configure your review cycles — annual, biannual, or quarterly. Most enterprises run annual with a mid-year light touch.
2. Define your competency framework. Reuse the competencies from your interview scorecards if at all possible — this is what creates the hiring-to-performance loop. Common frameworks: role-specific technical competencies + a shared set of leadership / collaboration competencies.
...
**This is a long game.** Performance Management produces useful insights after one full review cycle (a year for most enterprises). On day one, the data is empty. Don't expect to wire this up Monday and have insights Friday — set the framework now, run the cycles, and the insights compound.

## Checklist

- [ ] Internal Job Board is enabled with a clear visibility policy and manager-routing rule
- [ ] Hiring managers are trained to give internal candidates a real process
- [ ] Critical roles are identified with one to three potential successors each, and quarterly review is scheduled
- [ ] Performance Management cycles are configured with a competency framework that overlaps with interview scorecards
- [ ] After one cycle, you've run the Hiring-to-Performance Report and acted on at least one insight

## Features covered in this chapter

| # | Feature | Tier |
|---|---------|------|
| 1 | Internal Job Board | Premium |
| 2 | Succession Planning | Premium |
| 3 | Performance Management | Premium |
