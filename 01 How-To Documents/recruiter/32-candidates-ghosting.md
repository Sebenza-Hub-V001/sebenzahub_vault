...
# Chapter 32 — "Candidates are ghosting between stages"

You sourced them. You screened them. They were enthusiastic in the first call. Then — silence. They stopped opening emails, stopped replying to WhatsApp, stopped showing up. Ghosting is the most demoralising failure mode in recruitment because it feels personal even when it isn't. This chapter is about the diagnostic, the prevention, and the recovery.

## What ghosting actually looks like

Open the Pipeline (Chapter 16) and filter to **Stage age > 5 days**. Look at each card. The candidates you can identify as "ghosting" usually share these patterns:
...
**Detection:** The Offer Predictor (Chapter 20) returned low acceptance probability. Or the candidate was strong and senior — those are the ones with multiple options.

**Prevention:** Move faster. Reduce time-to-offer. Be the first credible offer they receive.
...
**Prevention:** The 30-second response rule (Chapter 22). Even when you don't have an update, send a "still in review, expect news by [date]" message. Silence kills.

### 3. The job didn't match what they expected
...
**Prevention:** Be honest in the first call. Don't oversell to keep them interested. The candidate who walks away after an honest first call is better than the candidate who ghosts after stage 4.
...
**Detection:** They went quiet after seeing the salary. They were active until then.

**Prevention:** Ask the salary question early. First call, no later. "What's your minimum acceptable total compensation for a move?" Don't take "depends" as an answer.
...
**Prevention:** None — but soft re-engagement after 30 days often re-activates them when life settles down.

## The detection signals to watch

The platform has three signals that predict ghosting before it happens:

### Engagement Score (Chapter 26)
...
**Action:** Read the message that triggered the flag. Often it's a small concern you can address before it festers.

### Stage age in the Pipeline (Chapter 16)

Days stuck at one stage. Beyond 5–7 days at any stage, the risk of ghosting climbs sharply.

**Action:** Daily Pipeline triage. The "stuck > 2 days, my candidates" filter is your morning starting view.
...
| **First call → screening** | Salary surprise, role surprise, scheduling friction |
| **Screening → interview** | Process is too slow; they got a competing offer |
...
### 1. The 30-second response rule (from Chapter 22)

Every inbound candidate message gets a response within 30 seconds, even if the response is "Got your message, will reply properly by EOD." Silence is the #1 cause of disengagement.
...
- **Don't send guilt messages.** "After all the time I invested in you" is the fastest way to ensure you never hear from them again.
- **Don't escalate to their current employer.** Ever. Career-ending move.
...
- [ ] You're applying the 30-second response rule
- [ ] You send status updates between stages, not just when you have news
- [ ] You have a recovery sequence ready (Day 1 / Day 4 / Day 8)
- [ ] You move ghosted candidates to a re-engagement pool, not delete them
