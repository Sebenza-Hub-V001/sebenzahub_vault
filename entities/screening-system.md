...
The Screening System is Sebenza Hub's candidate evaluation engine — covering everything from AI chatbot screening to competency tests, assessment bundles, and background checks. It sits between application submission and the interview stage in the [[concepts/application-lifecycle|hiring pipeline]].
...
- [[concepts/application-lifecycle]] — Screening sits between apply and interview
- [[entities/recruiter-user]] — Primary user of screening tools
- [[entities/business-user]] — Also uses screening
- [[concepts/ai-features]] — AI powers scoring, chatbot, and recommendations
