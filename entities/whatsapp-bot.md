...
- How does Contact CRM lifecycle sync with the main platform's [[concepts/application-lifecycle]]?
- What's the current fallback rate (% of messages bot can't handle)?
- How are screening bot questions configured per role?

## References

- [[concepts/whatsapp-integration]] — Concept overview
- [[entities/recruiter-user]] — Recruiter WhatsApp features (16 tabs)
- [[entities/admin-user]] — Admin WhatsApp management (20 tabs)
- [[entities/individual-user]] — Candidate experience via WhatsApp
- [[concepts/ai-features]] — AI-powered screening, matching, sentiment
- [[concepts/compliance]] — POPIA consent in WhatsApp
