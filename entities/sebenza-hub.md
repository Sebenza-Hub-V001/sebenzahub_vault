...
See [[concepts/tech-stack]] for full details.
...
|-----------|-------------|------------|
| Individual (Job Seeker) | [[entities/individual-user]] | `individual` |
| Recruiter (Talent Agency) | [[entities/recruiter-user]] | `recruiter` |
| Business (Employer) | [[entities/business-user]] | `business` |
| Admin (Platform Operator) | [[entities/admin-user]] | `admin` |
