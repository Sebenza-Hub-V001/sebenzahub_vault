...
See [[02-concepts/application-lifecycle]] for pipeline status details.
...
Subscription management (7 tabs: overview, value/ROI, credits, budget, invoices, plans, settings). Some features are credit-metered (e.g., AI operations). See [[02-concepts/billing-system]].
