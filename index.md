...
- [[entities/individual-user]] — Job seeker: search jobs, build skills, manage career
- [[entities/recruiter-user]] — Talent agency: source candidates, manage clients, earn placement fees
- [[entities/business-user]] — Employer / corporate HR: post jobs, hire, manage workforce
- [[entities/admin-user]] — Platform operator: configure features, monitor health, enforce compliance
- [[entities/offer-system]] — Full offer lifecycle: creation, approval chains, negotiation, compliance
...
- `raw/articles/individual-features.md` — 56 Individual features detailed guide
- `raw/articles/recruitment-features.md` — 95+ Recruiter features detailed guide
