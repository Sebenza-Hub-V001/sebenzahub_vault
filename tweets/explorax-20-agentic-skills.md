...
This aligns with the broader trend (see [[tweets/karpathy-llm-knowledge-bases]], [[tweets/farzatv-farzapedia-personal-wiki]]) of structuring AI interactions via persistent markdown artifacts rather than ephemeral chat.
...
Sebenza Hub already has **383+ AI-specific endpoints** across three providers ([[concepts/ai-features]]). The agentic skills pattern offers a way to **modularise and extend** Sebenza Hub's AI capabilities without building new endpoints for every feature. Several of these skills map directly to existing or planned Sebenza Hub features:

- **SCQA Writing Framework** → Could improve [[entities/screening-system]] chatbot conversations and [[concepts/ai-features|AI cover letter generation]]
- **Content Repurposing Engine** → Job descriptions could auto-generate social posts, WhatsApp messages, email campaigns from a single JD ([[entities/whatsapp-bot]])
...
- **Knowledge Structuring** → Underpin the [[entities/community-learning-hub]] content organisation
...
|---|---------------|---------------|--------|--------|
| 1 | **Build an "AI Skills Registry"** — Create a platform-level registry of reusable AI skill prompts (`.md` files) that power each AI feature. Admin can add/edit/disable skills per feature. This decouples AI behaviour from code, allowing rapid iteration. | [[entities/admin-user]], [[concepts/ai-features]] | high | high |
| 2 | **Content Repurposing for Job Postings** — When a Business creates a JD, auto-generate WhatsApp broadcast text, LinkedIn post, email snippet, and SMS summary from the same source. Uses the "Content Repurposing Engine" pattern. | [[entities/business-user]], [[entities/whatsapp-bot]], [[entities/linkedin-integration]] | medium | high |
| 3 | **Brand Voice Enforcer for Businesses** — Let Businesses configure a "tone profile" (formal/casual, industry jargon level, etc.) that all AI-generated content respects. Applies to JDs, chatbot responses, offer letters, outreach messages. | [[entities/business-user]], [[concepts/ai-features]] | medium | medium |
| 4 | **SCQA Framework for Screening Bot** — Structure the [[entities/screening-system]] chatbot's questioning flow using Situation-Complication-Question-Answer to improve candidate experience and extract more structured data. | [[entities/screening-system]], [[entities/whatsapp-bot]] | low | medium |
| 5 | **Competitive Intelligence Dashboard for Recruiters** — Provide recruiters with AI-synthesised market intelligence: competitor hiring patterns, salary benchmarks, talent availability by region/skill. Uses the "Competitive Intelligence Skill" and "Deep Research Synthesiser" patterns. | [[entities/recruiter-user]], [[concepts/ai-features]] | high | high |
| 6 | **Skill Creator Meta-Skill for Admin** — Allow platform admins to use AI to generate new AI skill prompts from natural language descriptions. This makes the AI Skills Registry (Rec #1) self-extending. | [[entities/admin-user]], [[concepts/ai-features]] | medium | medium |
...
- Related wiki pages: [[concepts/ai-features]], [[entities/screening-system]], [[entities/whatsapp-bot]], [[entities/linkedin-integration]], [[entities/community-learning-hub]], [[entities/admin-user]]
- Related tweets: [[tweets/karpathy-llm-knowledge-bases]], [[tweets/farzatv-farzapedia-personal-wiki]], [[tweets/aiedge-claude-skills-guide]] (architectural depth: progressive loading, A/B testing, trigger optimisation for the skill pattern)
