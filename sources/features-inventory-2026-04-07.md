...
**Raw file:** `raw/data/features-inventory.md`
**Ingested:** 2026-04-07
...
- [[entities/sebenza-hub]] — Platform scale metrics
- [[entities/individual-user]] — 85 dashboard pages, 42 features
- [[entities/recruiter-user]] — 86 dashboard pages, 86 features
- [[entities/business-user]] — 15 dashboard pages
- [[entities/admin-user]] — 104 dashboard pages
- [[concepts/billing-system]] — 18 subscription plans, metered vs boolean features
- [[concepts/rbac]] — Granular role management (13+ admin role tabs)
- [[concepts/whatsapp-integration]] — 12 admin WhatsApp sub-pages
...
> ⚠️ **Tension:** [[sources/repo-audit-2026-04-07]] counted 464 frontend pages, while this inventory lists 325. The ~139 difference may represent sub-components counted as pages in the audit but not as routes in this inventory.

## Open Questions

- What are the exact 18 subscription plans and their pricing? (See [[questions/subscription-plans]])
- How are the 157 seeded features distributed across plans?

## References

- [[entities/sebenza-hub]] — Platform entity
- [[concepts/billing-system]] — Subscription and feature gating
- [[sources/repo-audit-2026-04-07]] — Earlier codebase audit
