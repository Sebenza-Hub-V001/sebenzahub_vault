...
**Raw file:** `raw/articles/whatsapp-bot-training-manual.md`
**Ingested:** 2026-04-07
...
- [[concepts/whatsapp-integration]] — Expanded significantly by this source
- [[entities/recruiter-user]] — 16-tab recruiter WhatsApp dashboard
- [[entities/admin-user]] — 20-tab admin WhatsApp command center
- [[entities/individual-user]] — Candidate experience via WhatsApp
- [[concepts/ai-features]] — AI-powered screening, matching, sentiment detection
- [[concepts/compliance]] — POPIA consent flow in WhatsApp
...
> ⚠️ **Tension:** The bot supports 6 SA languages for greetings, but [[sources/ai-enhancement-opportunities-2026-04-07]] flags multi-language AI as a high-effort unimplemented feature. The bot's language support appears to be template-based greetings only, not full AI conversation in multiple languages.
...
- [[entities/recruiter-user]]
- [[entities/admin-user]]
- [[entities/individual-user]]
