...
An audit of the [[workflows/individual-journey]] document against the full Individual feature set from [[sources/individual-features-2026-04-07]]. The journey covered ~40% of actual features — the linear "signup → hired" path — but missed the platform's breadth.
...
- [[entities/individual-user]] — already documents most missing features
- [[entities/community-learning-hub]] — Learning Hub and Community depth
- [[concepts/ai-features]] — AI tools for Individuals
- [[concepts/billing-system]] — Account billing
- [[workflows/individual-journey]] — the document being audited

## Contradictions / Tensions

> ⚠️ **Tension:** The [[entities/individual-user]] page already lists all 57 features comprehensively, but [[workflows/individual-journey]] only covers 40% of them. This creates an inconsistency where the entity page promises features the journey doesn't explain.
...
- [[workflows/individual-journey]] — Document being audited
